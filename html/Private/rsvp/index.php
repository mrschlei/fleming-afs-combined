...
<head>
   ...
   header("Location: nutrition-seminar.php");
   ?>
...
<div class="breadcrumbs"><a href="http://fleming.bf.umich.edu">Home</a> &gt; <a href="http://fleming.bf.umich.edu/wellnesscommittee">Wellness Committee</a> &gt; Summer 2014 Healthy Cooking Demonstration</div>  
      
<h1>Summer 2014 Healthy Cooking Demonstration</h1>


<p>
<span class="info">Date:</span> August 21 from 12-1pm 
<br><span class="info">Location:</span> 5075 Fleming  
<?
include "../config.php";

$thisevent = "Aug 21 Healthy Cooking";

$query = "SELECT * FROM `rsvp` WHERE `event` = '$thisevent'";
...
<p><a href="http://fleming.bf.umich.edu/wellnesscommittee/documents/summer2014-cooking-demo.pdf" target="_blank"><img src="/images/pdficon.gif" alt="PDF" border="0" /></a> <a href="http://fleming.bf.umich.edu/wellnesscommittee/documents/summer2014-cooking-demo.pdf" target="_blank">More Information</a></p>
...
<input type="hidden" name="event" value="<? echo $thisevent; ?>" />
