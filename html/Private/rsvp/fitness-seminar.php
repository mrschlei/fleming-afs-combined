...
<div class="breadcrumbs"><a href="http://fleming.bf.umich.edu">Home</a> &gt; <a href="http://fleming.bf.umich.edu/wellnesscommittee">Wellness Committee</a> &gt; Fitness Seminar</div>  
      
<h1>Fitness Seminar</h1>


<p>
<span class="info">Date:</span> April 29th, 2015, 12:10pm
<br><span class="info">Location:</span> Fleming Building, Regent's Room
<?
include "../config.php";
$query = "SELECT * FROM `rsvp` WHERE `event` = 'Fitness Seminar'";
...
<p><a href="http://fleming.bf.umich.edu/wellnesscommittee/documents/fitness-seminar-042015.pdf" target="_blank"><img src="/images/pdficon.gif" alt="PDF" border="0" /></a> <a href="http://fleming.bf.umich.edu/wellnesscommittee/documents/fitness-seminar-042015.pdf" target="_blank">More Information</a></p>
...
<tr><td width="100">Name:</td><td><input type='text' name='name' size="45" value="<? echo $name; ?>"  /></td></tr>
...
<input type="hidden" name="event" value="Fitness Seminar" />
